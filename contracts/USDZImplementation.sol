...
contract USDZImplementation {
    ...
    string public constant name = "ZAMZAM USD"; // solium-disable-line
    string public constant symbol = "USDZ"; // solium-disable-line uppercase
    ...
    */
    ...
    function _betaDelegatedTransfer(
        ...
        bytes32 delegatedTransferHash = keccak256(abi.encodePacked(// solium-disable-line
                EIP712_DELEGATED_TRANSFER_SCHEMA_HASH, to, value, fee, seq, deadline //TODO!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            ));
